...
const AboutPage: React.FC = () => {
  return (
    <>
      <Head>
        <title>About BharatGen Technologies</title>
        <meta
          name="description"
          ...
          <section className="relative bg-gradient-to-r from-teal-600 to-cyan-500 py-16 md:py-24">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-lg sm:text-xl text-white/90 max-w-3xl mx-auto">
                Empowering the new generation of Bharat with modern, scalable,
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="md:w-1/2">
                  ...
                  <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
                    ...
                    headquartered in Prayagraj, Uttar Pradesh. We are dedicated
                    to transforming the digital landscape of Bharat by providing
                    cutting-edge technology solutions that empower businesses,
                    startups, and individuals. Our mission is to build a
                    smarter, more connected future through innovative and
                    meaningful technology that drives growth and efficiency.
                  </p>
                </div>
              ...
              <div className="flex flex-col md:flex-row gap-8 max-w-4xl mx-auto">
                <div className="flex-1 bg-white p-6 rounded-xl shadow-md">
                  ...
                  <p className="text-gray-700 text-sm sm:text-base">
                    ...
                    Uttar Pradesh. We specialize in software development,
                    offering a range of services from website and app
                    development to ERP, billing software, and IoT solutions. Our
                    goal is to support the digital journey of businesses and
                    individuals across Bharat.
                  </p>
                </div>
                <div className="flex-1 bg-white p-6 rounded-xl shadow-md">
                  <h3 className="text-lg sm:text-xl font-medium text-gray-900 mb-4">
          ...
          <section className="py-12 md:py-20 bg-gradient-to-r from-teal-600 to-cyan-500">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-white/90 text-sm sm:text-base max-w-2xl mx-auto mb-8">
                Join us in empowering the new generation of Bharat with
                innovative technology solutions. Contact us today to start your
                digital journey.
              </p>
              <a
